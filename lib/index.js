...
Invoice.prototype.getPlan = function() {
  var lines = this.user._stripe.last_invoice.lines
    , subscriptions = lines.data || lines.subscriptions
    , interval = subscriptions[0].plan.interval
...
Invoice.prototype.jade2pdf = function(callback) {
  ...
  // 1.bis. Check for a free port.
  portchecker.getFirstAvailable(12311, 33333, 'localhost', function(port, host) {
